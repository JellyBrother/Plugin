System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, instantiate, Node, resources, Sprite, SpriteFrame, UITransform, paiYidongowoefowfowwoiew, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, gamewooweuioasdlkjwojsdfiwoe;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("gamewooweuioasdlkjwojsdfiwoe", gamewooweuioasdlkjwojsdfiwoe = (_dec = ccclass('gamewooweuioasdlkjwojsdfiwoe'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec(_class = (_class2 = class gamewooweuioasdlkjwojsdfiwoe extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "moveNodexia_seef_234fwsefwinsoieoNIdoeoi", _descriptor8, this);
        ...
        playkaisoewoiwoiwefwwofoiww() {
          ...
          for (var _i = 0; _i < 5; _i++) {
            ...
            _a.parent = this.moveNodexia_seef_234fwsefwinsoieoNIdoeoi;
        ...
        kaishiyouxiowqiioweofowoiew() {
          ...
          this.xiaSelfrtghntWoisoeowoefos.children.forEach(item => {
            item.active = false;
            this.xiaPos_wiefoiweoiis.push(this.changePosesoeoiweofwoiefwwoei(item, this.moveNodexia_seef_234fwsefwinsoieoNIdoeoi));
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "moveNodexia_seef_234fwsefwinsoieoNIdoeoi", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=7add55da4b1a4f0e3f470f8b5c2469b070671361.js.map