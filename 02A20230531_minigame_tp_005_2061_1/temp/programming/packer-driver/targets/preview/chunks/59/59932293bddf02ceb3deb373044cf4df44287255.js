System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, instantiate, Node, resources, UITransform, paiYidongowoefowfowwoiew, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, gamewooweuioasdlkjwojsdfiwoe;
      ...
      _export("gamewooweuioasdlkjwojsdfiwoe", gamewooweuioasdlkjwojsdfiwoe = (_dec = ccclass('gamewooweuioasdlkjwojsdfiwoe'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class gamewooweuioasdlkjwojsdfiwoe extends Component {
        ...
        playkaisoewoiwoiwefwwofoiww() {
          for (var i = 0; i < 5; i++) {
            ...
            _a.setPosition(this.xiaPos_wiefoiweoiis[i]);
            ...
            _b.kaisPoswoeoeofwoeofowe = this.xiaPos_wiefoiweoiis[i];
...
//# sourceMappingURL=59932293bddf02ceb3deb373044cf4df44287255.js.map