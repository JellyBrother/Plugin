System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, instantiate, Node, resources, Sprite, SpriteFrame, UITransform, paiYidongowoefowfowwoiew, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _crd, ccclass, property, gamewooweuioasdlkjwojsdfiwoe;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("gamewooweuioasdlkjwojsdfiwoe", gamewooweuioasdlkjwojsdfiwoe = (_dec = ccclass('gamewooweuioasdlkjwojsdfiwoe'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec(_class = (_class2 = class gamewooweuioasdlkjwojsdfiwoe extends Component {
        constructor() {
          super(...arguments);
        ...
        start() {
          this.kaishiyouxiowqiioweofowoiew(); // this.paizhiAllwoeoeifowowe = this.getPaizhiAll12312fwef3r();
        ...
        kaishiyouxiowqiioweofowoiew() {
          this.paiIndex_esioiwfoiwfeoioiefwo = 0; // this.shangWoisoeowoefos.children.forEach((item) => {
          //     item.active = false;
          //     let pos = this.changePosesoeoiweofwoiefwwoei(item, this.moveNode_234fwsefwinsoieoNIdoeoi);
          //     console.log("这个坐标哪错了？？？？？", pos);
          //     this.shangPos_weifiwoiweioodifer.push(pos);
          // });

          var child = this.shangWoisoeowoefos.children;

          for (var i = 0; i < this.shangWoisoeowoefos.children.length; i++) {
            child[i].active = false; // let pos = this.changePosesoeoiweofwoiefwwoei(child[i], this.moveNode_234fwsefwinsoieoNIdoeoi);
            // this.shangPos_weifiwoiweioodifer.push(pos);
          } // this.xiaSelfrtghntWoisoeowoefos.children.forEach((item) => {
          //     item.active = false;
          //     this.shangPos_weifiwoiweioodifer.push(this.changePosesoeoiweofwoiefwwoei(item, this.moveNode_234fwsefwinsoieoNIdoeoi));
          // });
...
//# sourceMappingURL=9cac2075d6aa054df503e8640d4bb90acbffd7c1.js.map