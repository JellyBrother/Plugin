    ...
    execute: function () {
      ...
      _export("gamewooweuioasdlkjwojsdfiwoe", gamewooweuioasdlkjwojsdfiwoe = (_dec = ccclass('gamewooweuioasdlkjwojsdfiwoe'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec(_class = (_class2 = class gamewooweuioasdlkjwojsdfiwoe extends Component {
        constructor() {
          ...
          _initializerDefineProperty(this, "selfNode_jweiwoijefioweifiof", _descriptor9, this);
        ...
        playkaisoewoiwoiwefwwofoiww() {
          ...
          for (var _i = 0; _i < 5; _i++) {
            ...
            _a.parent = this.selfNode_jweiwoijefioweifiof;
        ...
        kaishiyouxiowqiioweofowoiew() {
          ...
          this.xiaSelfrtghntWoisoeowoefos.children.forEach(item => {
            item.active = false;
            this.xiaPos_wiefoiweoiis.push(this.changePosesoeoiweofwoiefwwoei(item, this.selfNode_jweiwoijefioweifiof));
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "selfNode_jweiwoijefioweifiof", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=d57a2cfb4bd04f3f1df879a05c278a83507bbad0.js.map