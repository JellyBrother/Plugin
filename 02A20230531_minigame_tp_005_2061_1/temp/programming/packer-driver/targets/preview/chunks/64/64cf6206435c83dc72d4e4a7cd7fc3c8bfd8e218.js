          ...
          if (zhoongNode[3].children[0] == undefined) {
            ...
            this.scheduleOnce(() => {
              ...
              var _loop = function _loop(i) {
                tween(shou[i]).to(0.2, {
                  position: _this.xiaPos_wiefoiweoiis[i]
                }).call(() => {
                  var card = shou[i].getComponent(_crd && paiYidongowoefowfowwoiew === void 0 ? (_reportPossibleCrUseOfpaiYidongowoefowfowwoiew({
                    error: Error()
                  }), paiYidongowoefowfowwoiew) : paiYidongowoefowfowwoiew);
                  card.kaisPoswoeoeofwoeofowe = _this.xiaPos_wiefoiweoiis[i];
...
//# sourceMappingURL=64cf6206435c83dc72d4e4a7cd7fc3c8bfd8e218.js.map