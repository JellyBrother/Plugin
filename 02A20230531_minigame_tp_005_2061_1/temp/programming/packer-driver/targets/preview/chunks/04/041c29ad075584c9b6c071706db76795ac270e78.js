System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, instantiate, Node, resources, Sprite, SpriteFrame, UITransform, paiYidongowoefowfowwoiew, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, gamewooweuioasdlkjwojsdfiwoe;
      ...
      _export("gamewooweuioasdlkjwojsdfiwoe", gamewooweuioasdlkjwojsdfiwoe = (_dec = ccclass('gamewooweuioasdlkjwojsdfiwoe'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class gamewooweuioasdlkjwojsdfiwoe extends Component {
        ...
        kaishiyouxiowqiioweofowoiew() {
          ...
          this.shangWoisoeowoefos.children.forEach(item => {
            item.active = false; // this.shangPos_weifiwoiweioodifer.push(this.changePosesoeoiweofwoiefwwoei(item, this.node));
          });
...
//# sourceMappingURL=041c29ad075584c9b6c071706db76795ac270e78.js.map