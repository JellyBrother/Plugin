      ...
      _export("paiYidongowoefowfowwoiew", paiYidongowoefowfowwoiew = (_dec = ccclass('paiYidongowoefowfowwoiew'), _dec2 = property(Node), _dec(_class = (_class2 = class paiYidongowoefowfowwoiew extends Component {
        ...
        moveWIIioiofweofoiw(event) {
          if (this.isMoveweofoiweofoiwofso) {
            ...
            console.log("iseoooooooooooooooo", posV2);
            let pos = this.changePosesoeoiweofwoiefwwoei_eiojwfiij(this.node, posV2);
            this.node.setPosition(pos); // this.node.setWorldPosition(v3(posV2.x, posV2.y))
          }
        } //写法要改
        ...
        changePosesoeoiweofwoiefwwoei_eiojwfiij(node, pos1) {
          var pos2 = node.getComponent(UITransform).convertToNodeSpaceAR(v3(pos1.x, pos1.y));
          return pos2;
        }
...
//# sourceMappingURL=6b4f6eadc7bc2ceec9338f74d1cf1ceccd8798f8.js.map