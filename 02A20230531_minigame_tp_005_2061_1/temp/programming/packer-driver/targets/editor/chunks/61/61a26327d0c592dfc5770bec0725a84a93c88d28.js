System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, tween, UITransform, v3, _decorator, Component, Node, NodeEventType, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, paiYidongowoefowfowwoiew;
    ...
    execute: function () {
      ...
      _export("paiYidongowoefowfowwoiew", paiYidongowoefowfowwoiew = (_dec = ccclass('paiYidongowoefowfowwoiew'), _dec2 = property(Node), _dec(_class = (_class2 = class paiYidongowoefowfowwoiew extends Component {
        constructor(...args) {
          ...
          this.isMoveweofoiweofoiwofso = null;
        }

        start() {
          this.kaisPoswoeoeofwoeofowe = true;
        }
...
//# sourceMappingURL=61a26327d0c592dfc5770bec0725a84a93c88d28.js.map