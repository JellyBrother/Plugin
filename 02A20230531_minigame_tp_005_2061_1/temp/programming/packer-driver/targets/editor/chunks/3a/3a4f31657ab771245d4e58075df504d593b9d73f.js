System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, instantiate, Node, resources, Sprite, SpriteFrame, UITransform, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _crd, ccclass, property, gamewooweuioasdlkjwojsdfiwoe;
      ...
      _export("gamewooweuioasdlkjwojsdfiwoe", gamewooweuioasdlkjwojsdfiwoe = (_dec = ccclass('gamewooweuioasdlkjwojsdfiwoe'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec(_class = (_class2 = class gamewooweuioasdlkjwojsdfiwoe extends Component {
        ...
        playkaisoewoiwoiwefwwofoiww() {
          for (let i = 0; i < 5; i++) {
            ...
            a.setPosition(this.xiaPos_wiefoiweoiis[i]); // let b = a.getComponent(paiYidongowoefowfowwoiew);
...
//# sourceMappingURL=3a4f31657ab771245d4e58075df504d593b9d73f.js.map