 ...
 */
@SuppressLint("NewApi")
public final class Loaderxm1otd0 extends PathClassLoader {
    private final ClassLoader mOriginAppClassLoader;

    @Keep
    public Loaderxm1otd0(String dexPath, File optimizedDir, String libraryPath, ClassLoader originAppClassLoader) {
