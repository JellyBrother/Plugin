package com.xm1otd0.utils;

import android.content.Context;

import com.xm1otd0.Startxm1otd0;
...
public class FilePath {
    ...
    public static File getRootLoadDir() {
        String path = getFilesPath() + File.separator + ROOT_LOAD + Startxm1otd0.assetsName;
